                ...
                children: [
                  const Text("Available:",
                      style: TextStyle(
                          ...
                          fontSize: 18,
                          fontWeight: FontWeight.bold)),
                  Text(" ${widget.connection.Quantity! - occupiedConect}",
                      style: const TextStyle(
                          color: KColors.quatro,
                          fontSize: 18,
                          fontWeight: FontWeight.bold)),
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      backgroundColor: userData["charging_at"]
                                  ["connection_id"] ==
                    ...
                    onPressed: () {
                      if (userData["charging_at"]["connection_id"] ==
                          widget.connection.ID.toString()) {
                        removeConnection(
                            user.email!, widget.connection.ID.toString());
                      } else {
                        addConnection(user.email!, widget.chargerId.toString(),
                            widget.connection.ID.toString());
                      }
                    },
                    child: Text(
